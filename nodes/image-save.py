...
class KAndyImageSave:
    ...
    def INPUT_TYPES(cls):
        return {
            "required": {
                ...
                "positive": (
                    "STRING",
                    {"default": "", "multiline": True, "tooltip": "positive prompt"},
                ),
                "negative": (
                    "STRING",
                    {"default": "", "multiline": True, "tooltip": "negative prompt"},
                ),
            },
    ...
    def save_images(
        ...
        if show_previews == "true":
            return {
                "ui": {"images": results, "files": output_files},
                "result": (
                    images,
                    output_files,
                ),
